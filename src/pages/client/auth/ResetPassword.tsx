      ...
      >
        <div className="relative flex justify-center items-center gap-2 mb-2">
          <div className="text-center">
            <h1 className="text-third text-[25px] uppercase font-bold mb-2">
              Reset Mật khẩu
            </h1>
            <p className="ml-3 text-[13px] text-third">
        ...
        >
          ...
          <Text size="sm" className="text-center select-none">
            ...
            <span
              ...
              className="text-blue-600 hover:underline cursor-pointer mx-1"
            >
              gửi lại
            </span>
          </Text>
