...
import { getKits, deleteKitById } from '../../../services/kit.Service.ts';
        ...
        <div className="flex flex-col md:flex-row gap-4">
          ...
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 bkit rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
          </div>
          <button
            onClick={() => navigate(`/admin/addproduct`)}
            className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded flex products-center"
          >
